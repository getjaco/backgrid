...
var HeaderCell = Backgrid.HeaderCell = Backbone.View.extend({
  ...
  onClick: function (e) {
    ...
    function cycleSort(header, col) {
      if (column.get("direction") === "ascending") collection.trigger(event, col, null);
      else if (column.get("direction") === "descending") collection.trigger(event, col, "ascending");
...
var Body = Backgrid.Body = Backbone.View.extend({
  ...
  */
  sort: function (column, direction) {
    ...
    if (collection.pageableCollection) {
	    collection = collection.pageableCollection;
    }
    ...
    if (Backbone.PageableCollection &&
      ...
      if (collection.fullCollection && collection.mode == 'client') {
